...
- `presentation/security` : integration Spring Security, lecture du header `ClientId`, transformation des droits en authorities, controle d'acces par `@PreAuthorize` et traduction des refus en erreurs HTTP.
